...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../src/components/signup.js":[function(require,module,exports) {
$(document).ready(function () {
  ...
  $('#signUpForm').on('submit', function (event) {
    ...
    $.ajax({
      ...
      error: function error(jqXHR) {
        console.log(jqXHR);
        var responseValidation = jqXHR.responseText;
  ...
  var $inputs = $('#signUpForm input[required]');
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../src/components/signup.js"], null)
//# sourceMappingURL=/signup.a03522f8.js.map